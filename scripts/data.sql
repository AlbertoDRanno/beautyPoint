...
(1, 'Dr. Enero', NULL, NULL, 1),
(2, 'Humectación', NULL, NULL, 1),
(3, 'Cuidados Masculinos', NULL, NULL, 1),
(4, 'Antiage', NULL, NULL, 1);
UNLOCK TABLES;
...
(1, '70 ml', NULL, NULL, 1),
(2, '130 ml', NULL, NULL, 1),
(3, '250 g', NULL, NULL, 1),
(4, 'unidad', NULL, NULL, 1),
(5, '250 ml', NULL, NULL, 1),
(6, '500 ml', NULL, NULL, 1),
(7, '60 g', NULL, NULL, 1),
(8, '15 ml', NULL, NULL, 1);
UNLOCK TABLES;
...
(2, 'Paul', 'Gomez', 30123987, 'paul@laca.com.ar', 1, '/images/dataset/avatar_prueba_04.jpg', '$2a$10$RLvCG1TvBVfgc.tXaTdbVe/1wD7/mlk1dMPhhI.SIWOQYemmTteDG', NULL, NULL, 1, '456-0011');
UNLOCK TABLES;
