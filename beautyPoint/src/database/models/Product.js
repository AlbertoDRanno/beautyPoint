module.exports = (sequelize, DataTypes) => {
  ...
  Product.associate = function (models) {   // recibe todos los modelos que tenemos
    ...
    Product.belongsToMany(models.User, {  // Muchos a Muchos  // 1er parámetro, el modelo al que asocio
      as: "users", //alias
